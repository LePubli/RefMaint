      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700">
          ...
          <div className="mt-4 p-3 bg-gray-700/50 rounded-lg text-xs text-gray-400">
            <p className="font-medium text-gray-300 mb-1">Compte par défaut :</p>
            <p>Utilisateur : <span className="text-orange-400">admin</span></p>
            <p>Mot de passe : <span className="text-orange-400">admin123</span></p>
          </div>
        </div>
      </div>
    </div>
